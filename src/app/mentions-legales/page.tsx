    ...
    <div className="pt-24 pb-24">
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto space-y-12">
          <h1 className="font-playfair text-4xl md:text-5xl text-center text-white">
            Mentions Légales
          </h1>

          <div className="space-y-8 text-white/70">
            <div className="space-y-3">
              <h2 className="font-playfair text-2xl text-white">Éditeur du site</h2>
              <p>
                KŌDŌ — Les sources olfactives<br />
                Parfumerie artisanale<br />
                Paris, France
              </p>
            </div>

            <div className="space-y-3">
              <h2 className="font-playfair text-2xl text-white">Contact</h2>
              <p>
                Email : contact@kodo-parfums.com<br />
                Instagram : @kodo
              </p>
            </div>

            <div className="space-y-3">
              <h2 className="font-playfair text-2xl text-white">Hébergement</h2>
              <p>
